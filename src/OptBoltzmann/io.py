...
def dataframes2simplesbml(Stoich_matrix: pd.DataFrame, reactions: pd.DataFrame, metabolites: pd.DataFrame, Keq: pd.DataFrame, compartment_volume)->simplesbml.SbmlModel:
